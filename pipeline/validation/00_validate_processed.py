# pipeline/validation/00_validate_processed.py
#!/usr/bin/env python3
import json
from pipeline.core.paths import PROCESSED_FILE
...
def main() -> int:
    ...
    print(f"[OK] file: {PROCESSED_FILE}")
    ...
    if isinstance(first, dict):
        ...
        print(
            ...
            type(films).__name__,
            "len:",
            (len(films) if hasattr(films, "__len__") else "n/a"),
        )
        print(
            "  stats:",
            type(stats).__name__,
